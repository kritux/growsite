...
class ClientService(Base):
    ...
    entregables = Column(JSONB, default=list)  # Lista de objetos: {nombre, ruta, fecha, comentarios}
    historial_cambios = Column(JSONB, default=list)  # Lista de cambios/comentarios
